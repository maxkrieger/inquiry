(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://a9.io/inquiry/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://a9.io/inquiry/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://a9.io/inquiry/assets/css/just-the-docs-' + theme + ".css"
      );
    };
